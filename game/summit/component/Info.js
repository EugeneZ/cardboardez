            ...
            <div style={styles.container}>
                <Paper style={styles.roleContainer}>
                    ...
                    {this.props.roles.map(
                        role => <div><div style={styles.lineItem}><strong>{role.label}</strong><br/>{role.description}</div><Divider/></div>
                    )}
                </Paper>
                <Paper style={styles.orderContainer}>
                    <Subheader>Night Order</Subheader>
                    {this.props.order.map(
                        order => <div><div style={styles.lineItem}>{order}</div><Divider/></div>
                    )}
                </Paper>
            </div>
        );
